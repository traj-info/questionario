...
class Navegacao
{
	...
	/**
	 * Adiciona opcoes que irao aparecer no combo para numero de registros por pagina
	 * @param int $valor
	 */
	...
	public function Header($retorno = null)
	{
		$retorno['header'] = $this->FiltroHeader();
		$retorno['action'] = $this->ActionFiltros();
		$retorno['navbar'] = $this->NavegacaoForm($retorno);
	...
	/**
	 * 
	 * Configuracao do filtro para atualizacao da lista
	...
	public function NavegacaoForm( $retorno = null)
	{
		if(is_null($retorno))
		{
		...
		{
			$retorno['TotalRegistros'] = $retorno['TotalRegistros'];
			$retorno['TotalPaginas'] =  $retorno['TotalPaginas'];;
